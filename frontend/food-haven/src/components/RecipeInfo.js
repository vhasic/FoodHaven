...
class RecipeInfo extends React.Component {
    ...
    componentDidMount() {
            if (this.props.user) {
                const { image, imageFile, imageSrc} = this.props.user
                this.setState({ image, imageFile, imageSrc});
            }
    }
  ...
  render() {
        return (
            <div>
                ...
                <a style={{textDecoration:"none", color:"#ff6127", fontSize:"150%", marginLeft:"10%"}} href='./UserPage'> <i className="fas fa-angle-left"></i> Cancel</a>  
                <a style={{textDecoration:"none", color:"#ff6127", fontSize:"150%", marginLeft:"61%"}} href='./Instructions'> Next <i className="fas fa-angle-right"></i> </a>  
